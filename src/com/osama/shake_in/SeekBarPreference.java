...
public final class SeekBarPreference extends DialogPreference implements
	...
	private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/com.osama.shake_in";
	...
	private static final int DEFAULT_CURRENT_VALUE = 193;
	...
	protected void onDialogClosed(boolean positiveResult) {
		...
		if (shouldPersist()) {
			...
			PreferenceManager.getDefaultSharedPreferences(getContext()).edit()
					.putInt("seekBarPreference", mCurrentValue);

			// XXX: how to get the value from that view?
			// XXX: you can edit this later.
